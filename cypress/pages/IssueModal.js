class IssueModal {
  constructor() {
    ...
    this.confirmTitle = "Are you sure you want to delete this issue?";
    this.confirmMessage = "Once you delete, it's gone for good.";
  }
  ...
  clickDeleteButton() {
    ...
    cy.get(this.confirmationPopup)
      .should("be.visible")
      .and("contain", deleteIssueText)
      .and("contain", deleteIssueTextConfirm);
  }
